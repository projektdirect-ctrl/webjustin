        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-white uppercase leading-tight mb-6">
              {t('contact_title_line1', 'Pojďme si')}<br />
              <span className="text-amber-400">{t('contact_title_line2', 'o tom říct.')}</span>
            </h2>
            <p className="text-white/60 text-lg leading-relaxed mb-12">
              {t('contact_subtitle', 'Ozvěte se nám — rádi vám připravíme bezplatnou cenovou nabídku. Pracujeme po celé ČR, primárně v Ústeckém kraji.')}
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-5 group">
                ...
                <div>
                  ...
                  <a
                    href={`tel:${t('contact_phone', '+420739389993').replace(/\s/g, '')}`}
                    className="text-white text-xl sm:text-2xl font-black hover:text-amber-400 transition-colors break-all"
                  >
                    {t('contact_phone', '+420 739 389 993')}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-5 group">
                ...
                <div>
                  ...
                  <a
                    href={`mailto:${t('contact_email', 'jrbprace@seznam.cz')}`}
                    className="text-white text-xl sm:text-2xl font-black hover:text-amber-400 transition-colors break-all"
                  >
                    {t('contact_email', 'jrbprace@seznam.cz')}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-5">
                ...
                <div>
                  ...
                  <div className="text-white text-lg sm:text-xl font-black">
                    {t('contact_hours_main', 'Po–Pá: 7:00 – 18:00')}
                  </div>
                  <div className="text-white/50 text-sm">{t('contact_hours_sub', 'So: po domluvě')}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-blue-900/50 border border-white/10 p-8">
              <div className="flex items-start space-x-4 mb-6">
                ...
                <div>
                  ...
                  <div className="text-white text-xl font-black mb-1">{t('contact_area_main', 'Celá Česká republika')}</div>
                  <div className="text-amber-400 font-bold">{t('contact_area_sub', 'Primárně Ústecký kraj')}</div>
                </div>
              </div>
            ...
            <div className="bg-amber-400 p-8">
              <div className="text-blue-950 text-2xl font-black uppercase mb-2">
                {t('contact_cta_title', 'Chcete nacenit projekt?')}
              </div>
              <p className="text-blue-900/70 text-sm mb-4">
                {t('contact_cta_text', 'Zavolejte nebo napište — ozveme se vám do 24 hodin s bezplatnou nabídkou.')}
              </p>
              <a
                href={`tel:${t('contact_phone', '+420739389993').replace(/\s/g, '')}`}
                className="inline-flex items-center space-x-2 bg-blue-950 text-white px-6 py-3 font-black uppercase tracking-wider text-sm hover:bg-blue-900 transition-colors"
              >
                <Phone className="h-4 w-4" />
                <span>{t('contact_cta_btn', 'Zavolat hned')}</span>
              </a>
            </div>
          </div>
        </div>
